    ...
    <div class="header">
                    <div class="container">
                        ...
                        <?php if (strlen($_SESSION['obbsuid']==0)) {?>
                            ...
                            <a href="#" class="icon-button" data-toggle="dropdown">
                                <span class="material-icons md-light">notifications</span>
                                <span class="label label-pill label-danger count" style="border-radius:10px;"></span>
                                                         
                            </a>
                    <ul class="dropdown-menu">
                    <?php
                   $sql3 = "SELECT * from `notifications` order by `date` DESC";
                  ...
                  <a style ="<?php
                             ...
                             ?>
                             " class="hvr-bounce-to-bottom" href="view-booking-detail.php">
                    <small><i><?php echo date('F j, Y, g:i a',strtotime($i['date'])) ?></i></small><br/>
                      <?php 
                      
                    if($i['status']=='Approved'){
                        echo "Yay! Your booking have been confirmed.";
                    }else if($i['status']=='Cancelled'){
                        echo "Sorry. Your booking have been cancelled.";
                    }
