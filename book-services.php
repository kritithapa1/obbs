...
if (strlen($_SESSION['obbsuid'] == 0)) {
	...
	<body>
					...
					<div class="col-md-6 contact-form-right">
						...
						<div class="agileinfo-contact-form-grid">
							...
							<div class="form-group row">
								...
								<div class="col-md-10">
									<input type="date" class="form-control" style="font-size: 20px" required="true" name="bookingfrom" id="bookingFrom">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-form-label col-md-4">Booking To:</label>
								<div class="col-md-10">
									<input type="date" class="form-control" style="font-size: 20px" required="true" name="bookingto" id="bookingTo">
								</div>
							</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-md-10">
										<input type="number" class="form-control" style="font-size: 20px" required="true"
											name="nop" min=50 max=1000 pattern="[0-9]+" />
									</div>
								</div>
								<div class="form-group row">
		...
		<script>
			...
			document.getElementById('bookingFrom').setAttribute('min', today);

			// Disable typing in the input field
			document.getElementById('bookingFrom').addEventListener('keydown', function(event) {
				event.preventDefault();
			});

			document.getElementById('bookingFrom').addEventListener('change', function() {
				var bookingFromDate = this.value;
				var bookingToInput = document.getElementById('bookingTo');
				
				bookingToInput.min = bookingFromDate;
			});
		</script>
