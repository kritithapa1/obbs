...
if(document.signup.fname.value== "" || document.signup.password.value== "" || document.signup.email.value== "" || document.signup.mobno.value== "" ){
...
if (!passwordPattern.test( document.signup.password.value)) {
	...
	<div class="contact">
		<div class="container">
			<div class="agile-contact-form">
				...
				<img src="images/four.jpg" alt="" height="500" width="500">
					</div>
				</div>
				<div class="col-md-6 contact-form-right">
					...
					<div class="agileinfo-contact-form-grid">
						<form method="post" name="signup" onsubmit="return checkpass();">
                                                ...
                                                <input type="text" name="mobno" placeholder="Mobile Number" minlength="10" maxlength="10" pattern="[0-9]+">
